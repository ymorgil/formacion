...
Esta página explica **exactamente cómo se organiza la prueba de certificación** en Canarias, qué se evalúa en cada parte y cómo se decide si el resultado final es "Apto" o "No apto". Entender esto de memoria es tan importante como estudiar gramática: saber qué se pide y cómo se puntúa cambia por completo la forma de prepararse.

> Fuente normativa: Real Decreto 1/2019 (principios básicos comunes a toda España), Orden de 15 de septiembre de 2022 (BOC nº 190, evaluación en Canarias) y Resolución de 5 de julio de 2023 (BOC nº 140, estructura de las pruebas). Los detalles exactos de cada convocatoria (duración en minutos, número de tareas) se confirman siempre en la **Guía para los aspirantes** del curso vigente, ya que pueden variar ligeramente de una convocatoria a otra.

## 🔢 Las cinco actividades de lengua

El examen de certificación, en todos los niveles (B1, B2, C1 y C2) y en todos los idiomas, se organiza siempre en torno a **cinco actividades de lengua**, cada una puntuada sobre 20 puntos (100 puntos en total):
...
5. **Mediación lingüística (MED)** — escrita y oral

La **mediación** es obligatoria desde el nivel B1 (antes solo se evaluaba a partir de B2 en algunas comunidades), así que hay que prepararla desde el primer nivel, no dejarla para más adelante.

## 🗓️ Dos sesiones, un único examen
...
### Sesión escrita (única y común)

Se realiza el mismo día para todos los aspirantes del mismo idioma y nivel, normalmente en un centro examinador designado. En esta sesión se evalúan de forma conjunta:
...
### Sesión oral (por EOI y turno)

Cada Escuela Oficial de Idiomas organiza sus propios turnos y horarios dentro del periodo fijado por la convocatoria (normalmente entre finales de mayo y mediados de junio). En esta sesión, ante un tribunal de dos examinadores, se evalúan:

- Producción y coproducción de textos orales (EIO): monólogo + interacción
- Mediación oral (parte de MED)

La prueba oral suele constar de un tiempo de **preparación previa** (lectura de las tarjetas/enunciados de la tarea) antes de entrar al aula, seguido de la intervención ante el tribunal.

## 📊 Puntuación y criterios de "Apto"
...
| Situación | ¿Resultado? |
|---|---|
| Las 5 partes ≥5 y media = 7,2 | ✅ Apto |
| Las 5 partes ≥5 y media = 6,5 exacto | ✅ Apto (cumple el mínimo) |
| 4 partes ≥5, una parte en 4,5, media = 6,8 | ❌ No apto (falla la condición 1) |
| Las 5 partes ≥5 pero media = 6,2 | ❌ No apto (falla la condición 2) |
...
`[captura pendiente: tabla oficial de duraciones exactas de la Guía para los aspirantes de la convocatoria vigente]`
...
## ⚠️ Errores frecuentes relacionados con la estructura
...
| Permitido | Prohibido |
|---|---|
| DNI/NIE y resguardo de inscripción | Diccionarios (papel o electrónicos) |
| Bolígrafo azul o negro (llevar de repuesto) | Traductores y dispositivos con conexión a internet |
| Reloj analógico sencillo, si se permite en la convocatoria | Teléfonos móviles encendidos o accesibles |
| Agua en botella transparente, según normas del centro | Apuntes, chuletas o cualquier material de consulta |
| Documentación de adaptaciones, si procede (necesidades educativas) | Auriculares o cualquier dispositivo de audio propio |

Cada centro examinador puede añadir normas específicas (por ejemplo, dónde dejar mochilas y móviles apagados durante la sesión). Conviene leer las instrucciones que se envían junto con la citación al examen.

## 🚪 Diferencias prácticas entre la sesión escrita y la oral

| | Sesión escrita | Sesión oral |
|---|---|---|
| Nº de aspirantes en el aula | Todo el grupo del nivel a la vez | Individual o en pareja, ante tribunal |
| Duración total aproximada | 2,5 - 3,5 horas seguidas | 15-25 minutos por aspirante, más tiempo de espera |
| Nervios más habituales | Gestión del tiempo entre tareas | Silencios, quedarse en blanco al hablar |
| Qué llevar mentalmente preparado | Estrategia de skim/scan (ver `03-comprension.md`) | Frases de "ganar tiempo" y de interacción (ver `05-expresion-oral.md`) |
| Consejo clave | No dejar ninguna pregunta en blanco: siempre es mejor una respuesta razonada que un hueco | Hablar con naturalidad aunque el examinador tome notas; no es un interrogatorio hostil |

## 🔍 Autoevaluación honesta antes de matricularse

Antes de decidir a qué nivel presentarme, conviene hacer una prueba de nivel real (modelo de examen completo, cronometrado) y comprobar sinceramente:

- ¿Entiendo la mayoría del texto/audio sin tener que traducir mentalmente palabra por palabra?
- ¿Puedo escribir el texto pedido dentro del tiempo y la extensión exigidos, sin quedarme en blanco?
- ¿Puedo mantener 3-5 minutos de conversación sobre el tema sin recurrir constantemente al español?
- ¿Reconozco al menos el 80% de las estructuras gramaticales que aparecen en el modelo de examen de ese nivel?

Si la respuesta es "no" en varias de estas preguntas, puede ser más rentable reforzar la base antes de matricularse, en lugar de presentarse "a ver qué pasa": las tasas de examen y el desgaste emocional de un suspenso evitable tienen un coste real.

## 🧮 Cómo se reparte la nota dentro de cada actividad

Cada una de las cinco actividades (20 puntos) suele dividirse a su vez en **varias tareas más pequeñas** con su propio peso (por ejemplo, en CE puede haber 4 tareas de 5 puntos cada una, o repartos distintos según el modelo de ese curso). Esto tiene una consecuencia práctica importante: **una tarea especialmente difícil dentro de una actividad no hunde toda la nota** si el resto se resuelven bien, así que nunca conviene bloquearse en una sola pregunta a costa de dejar sin responder las siguientes, más asequibles.
...
**Página anterior:** [`00-introduccion.md`](00-introduccion.md) · **Siguiente página:** [`02-tiempos-verbales.md`](02-tiempos-verbales.md) — la gramática imprescindible por nivel.

*Última revisión de esta página: consultar siempre la convocatoria vigente antes de dar por definitivos los datos de duración y número de tareas.*

`[captura pendiente: horario personal de mi convocatoria una vez publicado el Apéndice II]`
...
![Mapa de conectores](../assets/img/eoi/conectores_mapa.png)
...
![Frases clave para interactuar](../assets/img/eoi/frases_interaccion.png)
...
![Cómo funciona la mediación oral](../assets/img/eoi/mediacion_oral.png)
