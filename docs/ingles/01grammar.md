...
|---|---|---|---|---|
| much | /mʌtʃ/ | mucho/a | Con *uncountable nouns* en negativas e interrogativas | I don't have **much** time. / How **much** water do you need? |
| many | /ˈmɛni/ | muchos/as | Con *countable nouns* en negativas e interrogativas | There aren't **many** students here. / How **many** tickets are left? |
| a lot of | /ə lɒt əv/ | mucho/a, muchos/as | Con *countable* y *uncountable* en oraciones afirmativas | She has **a lot of** friends. / We need **a lot of** money. |
| lots of | /lɒts əv/ | muchísimos/as (informal) | Igual que *a lot of*, más coloquial | There are **lots of** options available. |
| a great deal of | /ə ɡreɪt diːl əv/ | una gran cantidad de | Formal; solo con *uncountable nouns* | It requires **a great deal of** effort. |
| a large number of | /ə lɑːdʒ ˈnʌmbər əv/ | un gran número de | Formal; solo con *countable nouns* | **A large number of** applicants were rejected. |
| all | /ɔːl/ | todo/a, todos/as | Con *countable* y *uncountable*; indica el total | **All** students must attend. / I drank **all** the milk. |
| all of | /ɔːl əv/ | todo/a de (referencia específica) | Antes de pronombres o determinantes (*the*, *my*, *this*...) | **All of** the team agreed. / **All of** us were tired. |
| most | /məʊst/ | la mayoría de | Sin artículo para generalizar | **Most** people prefer summer. |
| most of | /məʊst əv/ | la mayoría de (específico) | Con artículo o posesivo | **Most of** the students passed. / **Most of** my friends live abroad. |
| both | /bəʊθ/ | ambos/as, los dos | Solo con *countable nouns* en plural; exactamente dos elementos | **Both** options are valid. / I like **both** of them. |
| both of | /bəʊθ əv/ | los dos de | Antes de pronombres o determinantes | **Both of** my sisters are doctors. |
| either | /ˈiːðər/ | cualquiera de los dos | Dos opciones; positivo o negativo | You can take **either** road. |
| neither | /ˈnaɪðər/ | ninguno de los dos | Dos opciones; siempre negativo en significado | **Neither** answer is correct. |
| each | /iːtʃ/ | cada (uno por uno) | Enfatiza la individualidad; *countable* singular | **Each** student received a certificate. |
| every | /ˈɛvri/ | cada, todos los | Grupo considerado conjunto; *countable* singular | **Every** employee must sign this form. |
| enough | /ɪˈnʌf/ | suficiente/s | Antes de *noun*, después de *adjective/adverb* | We have **enough** chairs. / She isn't tall **enough**. |
| no | /nəʊ/ | ningún/a | Directamente antes del *noun*; más enfático que *not any* | There is **no** excuse for this behaviour. |
...
### Personales
Los pronombres cambian de forma según la función que cumplen en la frase: si hacen la acción (sujeto), si la reciben (objeto), si acompañan a un nombre indicando posesión (adjetivo posesivo), si sustituyen a ese nombre (pronombre posesivo) o si la acción recae sobre el propio sujeto (reflexivo).

| Persona | 1. Sujeto (Hace la acción) | 2. Objeto (Recibe la acción) | 3. Adj. Posesivo (Va con un nombre) | 4. Pron. Posesivo (Sustituye al nombre) | 5. Reflexivo (A uno mismo) |
|---|---|---|---|---|---|
| 1ª sing (Yo) | I | me | my | mine | myself |
| 2ª sing (Tú) | you | you | your | yours | yourself |
| 3ª sing (Él) | he | him | his | his | himself |
| 3ª sing (Ella) | she | her | her | hers | herself |
| 3ª sing (Cosa/Animal) | it | it | its | (No se usa) | itself |
| 1ª plural (Nosotros) | we | us | our | ours | ourselves |
| 2ª plural (Vosotros) | you | you | your | yours | yourselves |
| 3ª plural (Ellos) | they | them | their | theirs | themselves |

**EJEMPLOS**

- **1. Sujeto:** **I** love this book. *(Yo amo este libro.)*
- **2. Objeto:** This book teaches **me** a lot. *(Este libro me enseña mucho a mí.)*
- **3. Adj. Posesivo:** This is **my** jacket. *(Esta es mi chaqueta.)*
- **4. Pron. Posesivo:** That one is **yours**. *(Aquella es la tuya.)*
- **5. Reflexivo:** They painted the house **themselves**. *(Ellos mismos pintaron la casa / La pintaron por sí mismos.)*
...
| Demonstrative | Pronunciación | Significado | Distancia | Uso con noun | Ejemplo |
|---|---|---|---|---|---|
| this | /ðɪs/ | este/a, esto | Cerca (singular) | *Countable* singular o *uncountable* | **This** report covers the main issues. |
| that | /ðæt/ | ese/a, aquel/la, eso | Lejos (singular) | *Countable* singular o *uncountable* | **That** idea was proposed last year. |
| these | /ðiːz/ | estos/as | Cerca (plural) | *Countable* plural | **These** results are very promising. |
| those | /ðəʊz/ | esos/as, aquellos/as | Lejos (plural) | *Countable* plural | **Those** problems have now been resolved. |
 
**Usos avanzados de los demostrativos (B2/C1)**
 
| Uso | Descripción | Ejemplo |
|---|---|---|
| Referencia anafórica (*backward reference*) | *This/These* retoman algo mencionado antes | The company announced major layoffs. **This decision** sparked widespread protests. |
| Referencia catafórica (*forward reference*) | *The following / This* anticipan algo que se va a decir | **This** is what the data shows: prices have risen by 12%. |
| Contraste temporal | *This* (ahora) vs. *that* (entonces) | **This** government is more transparent than **that** of the previous decade. |
| Distancia emocional | *That* para distanciarse de algo negativo | **That** was a terrible mistake. |
| Uso pronominal (sin noun) | Actúan solos como pronombres | **This** is exactly what I meant. / **Those** were difficult times. |
 
> ⚠️ **Uso en writing académico/formal (muy valorado en EOI):**
> Usar *this + noun* (en lugar de solo *this*) hace el texto más preciso y cohesivo:
> - ~~*This is a big problem.*~~ → ✅ *This **situation** represents a significant challenge.*
 

### Indefinite
Los *indefinite pronouns* se refieren a **personas, cosas o lugares de forma no específica**. Se construyen con los prefijos **some-, any-, no-, every-** combinados con **-one / -body / -thing / -where**. La elección entre *some-* y *any-* sigue reglas similares a las de *some* y *any*.

**Regla general:**

- **some-** → oraciones afirmativas y ofrecimientos/peticiones
- **any-** → oraciones negativas e interrogativas
- **every-** → totalidad (todos, todo, en todas partes)
- **no-** → negación total (nadie, nada, en ningún lugar)
 
| Pronombre | Pronunciación | Significado | Uso principal | Ejemplo |
|---|---|---|---|---|
| **PERSONAS** | | | | |
| someone | /ˈsʌmwʌn/ | alguien | Afirmativo | **Someone** has left a message for you. |
| somebody | /ˈsʌmbɒdi/ | alguien (informal) | Afirmativo; más coloquial | **Somebody** forgot their umbrella. |
| anyone | /ˈɛniwʌn/ | alguien / nadie | Negativo, interrogativo, condicional | Is **anyone** available? / I haven't seen **anyone**. |
| anybody | /ˈɛnibɒdi/ | alguien / nadie (informal) | Negativo, interrogativo | Did **anybody** call while I was out? |
| no one | /ˈnəʊwʌn/ | nadie | Afirmativo en forma, negativo en significado | **No one** objected to the proposal. |
| nobody | /ˈnəʊbɒdi/ | nadie (informal) | Igual que *no one*; más coloquial | **Nobody** told me about the change. |
| everyone | /ˈɛvriwʌn/ | todo el mundo | Afirmativo; verbo en singular | **Everyone** is expected to contribute. |
| everybody | /ˈɛvribɒdi/ | todo el mundo (informal) | Afirmativo; verbo en singular | **Everybody** enjoyed the presentation. |
| **COSAS** | | | | |
| something | /ˈsʌmθɪŋ/ | algo | Afirmativo; oferta y petición | There is **something** I need to discuss with you. |
| anything | /ˈɛniθɪŋ/ | algo / nada | Negativo, interrogativo, condicional | I can't find **anything** useful here. / Do you need **anything**? |
| nothing | /ˈnʌθɪŋ/ | nada | Afirmativo en forma, negativo en significado | **Nothing** has changed since then. |
| everything | /ˈɛvriθɪŋ/ | todo | Afirmativo; verbo en singular | **Everything** was carefully planned. |
| **LUGARES** | | | | |
| somewhere | /ˈsʌmwɛər/ | en algún lugar | Afirmativo | I've seen this **somewhere** before. |
| anywhere | /ˈɛniwɛər/ | en algún lugar / en ningún lugar | Negativo, interrogativo, condicional | Have you looked **anywhere** else? / I can't find it **anywhere**. |
| nowhere | /ˈnəʊwɛər/ | en ningún lugar | Afirmativo en forma, negativo en significado | The suspect was **nowhere** to be found. |
| everywhere | /ˈɛvriwɛər/ | en todas partes | Afirmativo | The news spread **everywhere** within hours. |
 
**Some- vs. Any- : regla rápida**
 
| Contexto | Forma correcta | Ejemplo |
|---|---|---|
| Oración **afirmativa** | *some-* | **Someone** called you. / I need **something** to drink. |
| Oración **negativa** | *any-* | I don't know **anyone** here. / There isn't **anything** left. |
| Pregunta **neutral** | *any-* | Is there **anybody** home? / Have you seen it **anywhere**? |
| Pregunta con **oferta** | *some-* | Would you like **something** to eat? |
| Pregunta con **petición** | *some-* | Could you lend me **something** to read? |
| Oración **condicional** | *any-* | If **anything** goes wrong, call me. |
 
> ⚠️ **Concordancia verbal:** *everyone, everybody, everything, someone, nobody*, etc. → verbo siempre en **tercero de singular**:

>- *Everyone **is** ready.* / *Nobody **has** complained.*

> 🔑 **Truco B2/C1:** En el *writing* formal, prefiere *no one* sobre *nobody*, y *someone* sobre *somebody*. Son ligeramente más formales y apropiados en textos académicos o de opinión.

### Relativos


### Interrogativos
Las *Wh- questions* preguntan por información específica. En B2/C1 debes dominar también las **combinaciones con *How*** (que funcionan como un *quantifier* interrogativo) y las **preguntas indirectas** (*embedded questions*), muy frecuentes en la parte escrita del examen.
 
| Question Word | Pronunciación | Significado | Pregunta por | Ejemplo |
|---|---|---|---|---|
| What | /wɒt/ | qué, cuál | Cosa, información, acción | **What** are the main causes of climate change? |
| Who | /huː/ | quién | Persona (sujeto) | **Who** is responsible for this decision? |
| Whom | /huːm/ | a quién (formal) | Persona (objeto); formal/escrito | **Whom** did the manager contact? |
| Whose | /huːz/ | de quién | Posesión | **Whose** report is this? |
| Which | /wɪtʃ/ | cuál/cuáles | Elección entre opciones limitadas | **Which** option would you recommend? |
| When | /wɛn/ | cuándo | Tiempo | **When** was the policy last reviewed? |
| Where | /wɛər/ | dónde | Lugar | **Where** did the incident take place? |
| Why | /waɪ/ | por qué | Razón o causa | **Why** has production declined this year? |
| How | /haʊ/ | cómo | Manera, estado | **How** does this process work? |

**Combinaciones con How**
 
| Combinación | Pronunciación | Significado | Ejemplo |
|---|---|---|---|
| How much | /haʊ mʌtʃ/ | cuánto/a (*uncountable* o precio) | **How much** does it cost? / **How much** progress has been made? |
| How many | /haʊ ˈmɛni/ | cuántos/as (*countable*) | **How many** people attended the event? |
| How long | /haʊ lɒŋ/ | cuánto tiempo, qué longitud | **How long** have you been waiting? |
| How far | /haʊ fɑː/ | a qué distancia | **How far** is the nearest hospital? |
| How often | /haʊ ˈɒfən/ | con qué frecuencia | **How often** do you exercise? |
| How soon | /haʊ suːn/ | en cuánto tiempo (desde ahora) | **How soon** can you deliver the report? |
| How old | /haʊ əʊld/ | qué edad, cuántos años | **How old** is this building? |
| How well | /haʊ wɛl/ | qué tan bien | **How well** do you know the area? |
| How come | /haʊ kʌm/ | cómo es que, por qué (informal) | **How come** you didn't tell me earlier? |
| How likely | /haʊ ˈlaɪkli/ | qué tan probable | **How likely** is it that prices will fall? |
 
**Preguntas indirectas (*Embedded / Indirect Questions*)**
 
En B2/C1 son muy comunes en el *writing* y el *speaking*. El orden de las palabras cambia: **no se invierte el sujeto y el auxiliar**.
 
| Tipo | Estructura | Ejemplo directo → indirecto |
|---|---|---|
| Con *Wh-* word | *I wonder + wh- + sujeto + verbo* | *Where does he live?* → *I wonder **where he lives**.* |
| Con *if / whether* | *I'd like to know + if/whether + sujeto + verbo* | *Is she coming?* → *I'd like to know **if she is coming**.* |
| Con *Could you tell me* | *Could you tell me + wh- + sujeto + verbo?* | *What time is it?* → *Could you tell me **what time it is**?* |
| Con *Do you know* | *Do you know + wh- + sujeto + verbo?* | *When does it open?* → *Do you know **when it opens**?* |
 
> ⚠️ **Error muy frecuente:** ~~*Could you tell me where **is** the station?*~~ → ✅ *Could you tell me where **the station is**?*
