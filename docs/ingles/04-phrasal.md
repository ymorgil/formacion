...
| pick up | pik ap | contestar / coger (el teléfono) | *Pick up the phone, it's ringing!* — ¡Coge el teléfono, está sonando! |
...
| fill in / fill out | fil in / fil aut | rellenar (formulario) | *Fill in this form, please.* — Rellena este formulario, por favor. |
...
| Phrasal Verb | Suena así | Significado | Ejemplo |
|---|---|---|---|
| get on (with) | guet on (güid) | llevarse bien con | *I get on well with my colleagues.* — Me llevo bien con mis compañeros. |
| fall out (with) | fol aut (güid) | pelearse con, reñir | *They fell out over money.* — Riñeron por dinero. |
| make up | méik ap | reconciliarse | *They argued but made up quickly.* — Discutieron pero se reconciliaron rápido. |
...
| pick up | pik ap | recoger (a alguien) | *I'll pick you up at the airport.* — Te recogeré en el aeropuerto. |
...
Estos dos verbos generan casi todas las dudas porque comparten partícula pero cambian de significado según el contexto. Van juntos para que los compares de un vistazo:
...
| look after | luk áfter | cuidar | *Who looks after the baby?* — ¿Quién cuida al bebé? |
| look up | luk ap | buscar (información) | *Look up the meaning.* — Busca el significado. |
| look forward to | luk fórgüard tu | tener ganas de | *I look forward to seeing you.* — Tengo ganas de verte. |
| take off | téik of | despegar / quitarse | *The plane took off on time.* — El avión despegó a tiempo. |
| take on | téik on | asumir / contratar | *The company took on new staff.* — La empresa contrató nuevo personal. |
